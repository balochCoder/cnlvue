...
class UpdateRepresentingInstitutionRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'document_1' => ['sometimes','file'],
            'document_2_title' => ['nullable', 'string'],
            'document_2' => ['sometimes', 'file'],
    ...
    public function getData()
    {
        ...
        if ($this->hasFile('prospectus')) {
            ...
            $data['prospectus'] = Storage::url('/') . $this->prospectus->store($directory);
        }
